...
export class EducacionComponent implements OnInit {
  ...
  enviarEdu() {
    this.datosPorfolio
      .nuevaEducacion('https://back.portfoliorcruz.com/new/educacion', {
  ...
  editarEdu(id: any) {
    this.datosPorfolio
      .editarEducacion('https://back.portfoliorcruz.com/editar/educacion/' + id, {
        id: this.inputId,
        school: this.formEducacion.value.school,
        title: this.formEducacion.value.title,
        personaId: 1,
  ...
  borrarEdu(id: any) {
    this.datosPorfolio
      .borrarEducacion('https://back.portfoliorcruz.com/borrar_edu/' + id, {})
      .subscribe((respuesta) => {
