...
export class ProyectosComponent {
  ...
  enviarProyecto() {
    this.datosPorfolio.nuevoProyecto('https://back.portfoliorcruz.com/new/proyecto', {
  ...
  editarProyecto(id: any) {
    this.datosPorfolio.editarProyecto('https://back.portfoliorcruz.com/editar/proyecto/' + id, {
      "id": this.inputId,
      "nombre": this.formProyecto.value.nombre,
      "descripcion": this.formProyecto.value.descripcion,
      "personaId": 1,
  ...
  borrarProyecto(id: any) {
    this.datosPorfolio.borrarProyecto('https://back.portfoliorcruz.com/borrar_pro/' + id, {})
      .subscribe(respuesta => {
