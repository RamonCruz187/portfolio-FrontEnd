...
export class ProyectosComponent {
  ...
  enviarProyecto() {
    this.datosPorfolio.nuevoProyecto('https://backendportfolio-9azn.onrender.com/new/proyecto', {
  ...
  editarProyecto(id: any) {
    this.datosPorfolio.editarProyecto('https://backendportfolio-9azn.onrender.com/editar/proyecto/' + id, {
      "id": this.inputId,
      "nombre": this.formProyecto.value.nombre,
      "descripcion": this.formProyecto.value.descripcion,
      "personaId": 1,
  ...
  borrarProyecto(id: any) {
    this.datosPorfolio.borrarProyecto('https://backendportfolio-9azn.onrender.com/borrar_pro/' + id, {})
      .subscribe(respuesta => {
