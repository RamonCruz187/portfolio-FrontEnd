...
export class SkillsComponent {
  ...
  enviarHabilidad() {
    this.datosPorfolio
      .nuevaHabilidad('https://back.portfoliorcruz.com/new/tecnologia', {
        "id": "",
        "name": this.name,
  ...
  editarHabilidad(id: any) {
    this.datosPorfolio
      .editarHabilidad('https://back.portfoliorcruz.com/editar/tecnologia/' + id, {
  ...
  borrarHabilidad(id: any) {
    this.datosPorfolio.borrarHabilidad('https://back.portfoliorcruz.com/borrar_tecnologia/' + id, {})
      .subscribe(respuesta => {
