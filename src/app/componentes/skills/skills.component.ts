...
export class SkillsComponent {
  ...
  enviarHabilidad() {
    this.datosPorfolio
      .nuevaHabilidad('https://backendportfolio-9azn.onrender.com/new/tecnologia', {
        "id": "",
        "name": this.name,
  ...
  editarHabilidad(id: any) {
    this.datosPorfolio
      .editarHabilidad('https://backendportfolio-9azn.onrender.com/editar/tecnologia/' + id, {
  ...
  borrarHabilidad(id: any) {
    this.datosPorfolio.borrarHabilidad('https://backendportfolio-9azn.onrender.com/borrar_tecnologia/' + id, {})
      .subscribe(respuesta => {
